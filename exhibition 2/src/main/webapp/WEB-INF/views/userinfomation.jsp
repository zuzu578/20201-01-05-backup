...
<script src="https://kit.fontawesome.com/2cdf292f67.js" crossorigin="anonymous"></script>
...
<p class="userid">${userid }<a href="http://localhost:8080/project/DM?userid=${userid}"><i class="fab fa-facebook-messenger"></i></a></p><div class="form-check form-switch">
