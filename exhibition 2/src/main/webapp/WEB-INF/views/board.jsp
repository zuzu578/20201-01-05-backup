...
<div class="nav-items2"><a href="http://localhost:8080/project/DM">DirectMessage</a> </div>
<div class="nav-items2"><a href="http://localhost:8080/project/myCommunity">나의 정보</a> </div>
...
<div class="input-group mb-3">
 ...
 <table class="table table-striped" >
  ...
  <ul class="pagination justify-content-center">
    ...
    <li class="page-item">
      <a class="page-link" href="http://localhost:8080/project/Next">Next</a>
    </li>
  </ul>
</nav>
